...
const Home = () => {
  ...
  const testimonials = [
    {
      quote: "SolvionTech built the BB Chhatoi website with stunning design, smooth performance, reliable functionality, and seamless navigation, delivering powerful digital presence that exceeded.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  src="https://img.rocket.new/generatedImages/rocket_gen_img_1b6a3a777-1766573588659.png" 
